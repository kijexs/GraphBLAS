...
#define GB_JIT_KERNEL_KRONER_SELECTOR_PROTO(GB_jit_kernel_kroner_sel)   \
GrB_Info GB_jit_kernel_kroner_sel                                       \
(                                                                       \
    GrB_Matrix C,                                                       \
    const GrB_Matrix A,                                                 \
    const GrB_Matrix B,                                                 \
...
#define JIT_KRON_S(g) GB_JIT_KERNEL_KRONER_SELECTOR_PROTO(g) ;
